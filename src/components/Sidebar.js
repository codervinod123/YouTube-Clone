...
// const Sidebar = () => {
//   return (
//     <div className="w-[15rem] flex flex-col  min-w-fit transition-all duration-200 bg-zinc-900 text-white overflow-y-scroll">
//         <div className="flex w-[15rem] flex-col pl-2 pb-4 pr-6 text-sm ">
